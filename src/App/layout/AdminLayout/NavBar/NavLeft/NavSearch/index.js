                ...
                <div id="main-search" className={searchClass.join(' ')}>
                    <div className="input-group">
                        <input type="text" id="m-search" className="form-control"  
                            placeholder="Pesquisar . . ." onChange={(e) => this.props.handleTitle(e)} style={{width: this.state.searchString}}/>
                        <a href={DEMO.BLANK_LINK} onClick={this.props.handleSearch()} className="input-group-append search-close" onClick={this.searchOffHandler}>
